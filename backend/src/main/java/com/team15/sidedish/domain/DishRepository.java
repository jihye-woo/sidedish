...
public interface DishRepository extends CrudRepository<Dish, String> {
    @Override
    Optional<Dish> findById(@Param("hash") String hash);
    ...
    Optional<DishDAO> findByHash(@Param("hash") String hash);
    ...
    List<DishDAO> findAllBySection(@Param("section") String section);
